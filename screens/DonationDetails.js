...
const DonationDetails = ({ navigation, route }) => {
    ...
    function getitem() {
        ...
        fetch("https://gamerpatra.000webhostapp.com/appapi/login.php", {
            ...
            .then((resp) => {
                ...
                setItem(resp)
                setPercent(getPercent(resp.raised, resp.goal))
    ...
    function donate() {
        ...
        bodyContent.append("details", JSON.stringify(item));
    ...
    return (
        <View style={{
            ...
            <ScrollView>
                <View>
                    <Image
                        ...
                        source={{
                            uri: 'https://gamerpatra.000webhostapp.com/apis/upload/' + item.src,
                        }}
                    />
            ...
            <NativeBaseProvider>
                <Actionsheet isOpen={sucess} onClose={() => { setSucess(false) }} size="full">
                    <Actionsheet.Content>



                        <View style={{ height: tsh * 45, width: '100%' }}>
                            <Text style={{ alignSelf: 'center', color: '#999', fontSize: ts * 4.8, fontWeight: 'bold', marginTop: ts * 3 }}>Donation Sucessfull</Text>
                            <View style={{ justifyContent:'center',  height: tsh * 27,alignItems:'center' }}>
